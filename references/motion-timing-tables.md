<!-- Source: https://github.com/LottieFiles/motion-design-skill (MIT), skills/motion-design/reference/timing-easing-tables.md @ 2026-08-19.
     Copied verbatim as a lookup table. The rest of that skill (Disney 12 principles, personality archetypes) was deliberately left behind — knowledge can be looked up, criteria cannot. -->
